...
// function connectDB() {
    ...
    //ditambahkan logika untuk logout untuk mengakhiri sesi
    //jika sudah selesai mengakses web
    if (isset($_GET['logout'])) {
        session_destroy();  
        //ketika sesi telah dihancurkan pengguna diarahkan kembali ke login
...
<body>
    ...
    /
     <!-- Tombol Logout // Tambahan untuk logout -->
